...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  NSArray *vcs = [NSArray arrayWithObjects:self.vc1, self.vc2,self.vc1,self.vc1, self.vc2,self.vc1,self.vc2,self.vc1, self.vc2,self.vc1,self.vc1, self.vc2,self.vc1,self.vc2,self.vc1, nil];
